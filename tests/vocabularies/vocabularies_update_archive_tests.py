...
class VocabulariesUpdateArchiveTestCase(TestCase):
            ...
            "items": [
                {
                    ...
                    "is_active": True,
                    "translations": {"name": {"de": "Australien", "it": "Australia", "ja": "オーストラリア"}},
                },
                {
                    "name": "Austria",
            ...
            "items": [
                {
                    ...
                    "translations": {
                        "name": {"de": "Asset-Allokation", "it": "Asset allocation", "ja": "アセット・アロケーション"}
                    },
                },
                {
                    "name": "Risk",
                    ...
                    "translations": {"name": {"de": "Risiko", "it": "Rischio", "ja": "リスク"}},
                },
                {
                    "name": "Market context",
                    "parent": None,
    ...
    def test_is_changed(self):
        ...
        new_no_translations = {"name": "Market context", "parent": None, "qcode": "subject:03000000"}
    ...
    async def test_update_item(self):
        ...
        item = {
            ...
            "subject": [self.vocabularies_list[1]["items"][1], self.vocabularies_list[1]["items"][1]],
        }
