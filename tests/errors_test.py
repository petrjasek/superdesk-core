...
class ErrorsTestCase(TestCase):
    ...
    def test_raise_apiGeneralError(self):
        with pytest.raises(IngestApiError) as excinfo:
            try:
    ...
    def test_raise_folderCreateError(self):
        with pytest.raises(IngestFileError) as error_context:
            try:
    ...
    def test_raise_providerAddError(self):
        with pytest.raises(ProviderError) as error_context:
            try:
    ...
    def test_raise_ftpError(self):
        with pytest.raises(IngestFtpError) as error_context:
            try:
