...
class FTPFeedingService(FeedingService):
    ...
    fields = [
        ...
        {"id": "password", "type": "password", "label": "Password", "placeholder": "Password", "required": False},
        {"id": "path", "type": "text", "label": "Path", "placeholder": "FTP Server Path", "required": False},
        {"id": "dest_path", "type": "text", "label": "Local Path", "placeholder": "Local Path", "required": True},
        {
            "id": "passive",
            "type": "boolean",
            "label": "Passive",
