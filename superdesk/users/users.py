...
class UsersResource(Resource):
    def __init__(self, endpoint_name, app, service, endpoint_schema=None):
        ...
        self.additional_lookup = {"url": r'regex("[\w]+")', "field": "username"}
