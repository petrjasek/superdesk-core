...
def format_timedelta(
    datetime_or_timedelta: Any, granularity: str = ..., add_direction: bool = ..., threshold: float = ...
): ...
def format_number(number: Any): ...
def format_decimal(number: Any, format: Optional[Any] = ...): ...
def format_currency(
    number: Any, currency: Any, format: Optional[Any] = ..., currency_digits: bool = ..., format_type: str = ...
): ...
